...
# make sure the last 3 columns end with ","
tab_fil$V19 <- ifelse(grepl(",$", tab_fil$V19), tab_fil$V19, paste0(tab_fil$V19, ","))
tab_fil$V20 <- ifelse(grepl(",$", tab_fil$V20), tab_fil$V20, paste0(tab_fil$V20, ","))
tab_fil$V21 <- ifelse(grepl(",$", tab_fil$V21), tab_fil$V21, paste0(tab_fil$V21, ","))

# reorder filtered PSL file to create BED12
tab_bed <- tab_fil[, c("V14","V16","V17","V10","V22","V9",
                       "V16","V17","V23","V18","V19","V20")]

fwrite(tab_bed, args[2], sep = "\t", col.names = FALSE)
